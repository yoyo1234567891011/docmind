...
import { formatAnalyzeQuotaRemaining, formatLetterQuotaRemaining, formatSearchQuotaRemaining } from "@/lib/quotas/display";
            ...
            {[...quotas.items]
              ...
              >
                <span>
                  ...
                  {item.metric === "letter" && !item.unlimited ? (
                    <span className="mt-0.5 block text-xs text-[var(--muted)]">
                      {formatLetterQuotaRemaining(item)}
                    </span>
                  ) : null}
